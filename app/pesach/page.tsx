import { Ticket, Utensils, Leaf } from "lucide-react";
...
export default async function PesachPage() {
  const event = await getLatestEventByHoliday("pesach");
  ...
  return (
    <div>
      <SeasonHero title="Pesach" event={event} />
      ...
      <section className="container py-12 md:py-16">
        ...
        <div className="mt-12 p-6 rounded-lg border bg-muted/30">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
            ...
            <li>
              Kashering services are available for villas in select Orlando
              resort communities
            </li>
            <li>Lettuce bags are limited — order early to guarantee yours</li>
          </ul>
        </div>
      </section>
    </div>
